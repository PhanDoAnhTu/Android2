...
const ViewProductScreen = ({ navigation, route }) => {
  ...
  function fetchProduct() {
    (async function () {
      setIsloading(true);
      try {
        const products_data = await store_products_backend_service.getProductAndStoreProduct();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>Sản phẩm</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>Xem tất cả</Text>
        </View>
      </View>
