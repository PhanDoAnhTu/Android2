...
const CheckoutScreen = ({ navigation }) => {
  ...
  const handleCheckout = async () => {
    var order = await {
      ...
      "note": "ghi chu",
      "order_detail": cartproduct
    }
    try {
      const add_order = await order_service.checkout(order);
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.bodyContainer} nestedScrollEnabled={true}>
        ...
        <View style={styles.totalOrderInfoContainer}>
          ...
          <View style={styles.list}>
            <Text>Delivery</Text>
            <Text>{deliveryCost} Đ</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.primaryTextSm}>Total</Text>
            <Text style={styles.secondaryTextSm}>
              {totalCost + deliveryCost} Đ
            </Text>
          </View>
        </View>
        ...
        <View style={styles.listContainer}>
          ...
          <View style={styles.list}>
            ...
            <Text style={styles.secondaryTextSm}>{userInfo.phone}</Text>
          </View>
        </View>
